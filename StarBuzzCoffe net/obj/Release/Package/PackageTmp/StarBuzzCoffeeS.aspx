...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="FacturaCafe2" Height="218px" OnRowCommand="GridView1_RowCommand" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" Width="701px">
                <Columns>
            ...
            <asp:SqlDataSource ID="FacturaCafe2" runat="server" ConnectionString="<%$ ConnectionStrings:BDFactura_aspnetConnectionString %>" SelectCommand="SELECT * FROM [Factura]"></asp:SqlDataSource>
